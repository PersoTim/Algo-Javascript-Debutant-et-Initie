...
Créez une interface qui permette de lancer chaque exercice. Plus besoin de la console : chaque exercice à son bouton dédié, chaque interaction utilisateur passe par une boîte de dialogue, et chaque résultat s'affiche dans un emplacement dédié sur la page, remplaçant le résultat de l'exercice précédent. 
